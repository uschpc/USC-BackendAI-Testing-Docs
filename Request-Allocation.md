...
If the allocation is active in the CARC User Portal but you still cannot use it in Topanga, log out and back in,  and contact CARC support if the quota still does not appear.
